$(function () {
  ...
  var fileOption = '\
        ...
        <input type="text" id="{group}{i}VersionNo" maxlength="100" placeholder="version" class="span1" name="data[{n}][{i}][version_no]">\
        <input type="text" id="{group}{i}FileDate" maxlength="100" placeholder="dd-mm-yyyy" class="span2 datepickers" name="data[{n}][{i}][file_date]">\
  ...
  function enable_checklist() {
    if ($(this).is(':checked')) {
      ...
      // console.log($(this).closest('div.checkcontrols').find('label.checkcontrols'));
      if ($(this).closest('div.checkcontrols').next().children().length == 0) {
