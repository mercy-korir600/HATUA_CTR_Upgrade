              ...
              <ul class="nav topnav">
                ...
                <li class="dropdown <?php echo $this->fetch('Applications') ?>">
                  ...
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <i class="icon-thumbs-up"></i> Clinical Trials <b class="caret"></b>
                  </a>
                  <ul class="dropdown-menu">
                    <li>
                      <?php echo $this->Html->link('<i class="icon-thumbs-up"></i> Approved', array('controller' => 'applications', 'action' => 'index', 'admin' => false, 'status' => 'approved'), array('escape' => false)); ?>
                    </li>
                    <li>
                      <?php echo $this->Html->link('<i class="icon-remove"></i> Rejected', array('controller' => 'applications', 'action' => 'index', 'admin' => false, 'status' => 'rejected'), array('escape' => false)); ?>
                    </li>
                    <li>
                      <?php echo $this->Html->link('<i class="icon-stop"></i> Stopped', array('controller' => 'applications', 'action' => 'index', 'admin' => false, 'status' => 'stopped'), array('escape' => false)); ?>
                    </li>
                    <li>
                      <?php echo $this->Html->link('<i class="icon-pause"></i> Suspended', array('controller' => 'applications', 'action' => 'index', 'admin' => false, 'status' => 'suspended'), array('escape' => false)); ?>
                    </li>
                  </ul>
                ...
                <li class="dropdown <?php echo $this->fetch('Login') ?>">
                  ...
                  if ($this->Session->read('Auth.User')) {
                    echo $this->Html->link(
                      '<i class="icon-user"></i> ' . $this->Text->truncate($this->Session->read('Auth.User.username'), 12, array('ellipsis' => '..', 'html' => true)),
                      array('controller' => 'users', 'action' => 'profile', 'admin' => false,),
                      array('escape' => false)
                    );
                  } else {
                    echo $this->Html->link(
