...
$renderComparisonBlock = function ($comparisonText) use ($comparisonReviewerName) {
  ...
  return '<div class="well well-small internal-review-previous" style="margin-top: 8px; margin-bottom: 8px;">'
    . '<strong>' . h($comparisonReviewerName) . ' response (read-only):</strong><br>'
...
<?php if ($hasComparison) { ?>
  ...
  <div class="alert alert-info" style="margin-bottom: 10px;">
    ...
    Linked reviewer response is shown in <strong>blue</strong>.
    Your updates are highlighted in <strong>red</strong>.
    Empty fields are prefilled from the linked source so you can edit only sections you need.
            ...
            if ($questionType == 'label') {
              ...
              if ($hasComparison) {
                ...
                echo '<div class="internal-review-current-preview js-reviewer2-preview"' . $previewStyle . '>'
                  . '<strong>2nd reviewer update:</strong> '
