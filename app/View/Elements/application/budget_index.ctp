...
<div class="row-fluid">
  ...
  <div class="row-fluid">
    <div class="span12">
    <?php
      echo $this->Html->link('<i class="icon-file"></i> New Budget',
    ...
    <div class="marketing">
      <div class="row-fluid">
            <div class="span12">
              <h3>Budgets:<small> <i class="icon-glass"></i> Filter, <i class="icon-search"></i> Search, and <i class="icon-eye-open"></i> view reports</small></h3>
      ...
      <table class="table table-condensed table-bordered" style="margin-bottom: 2px;">
        <thead>
          <tr>
            <th style="width: 15%;">
              <?php
                echo $this->Form->input('grand_total_kshs',
                    array('div' => false, 'class' => 'span12 unauthorized_index', 'label' => array('class' => 'required', 'text' => 'Year.')));
              ?>
              </th>
              <th>
              <?php
              ...
              <?php
                echo $this->Form->input('start_date',
                  array('div' => false, 'type' => 'text', 'class' => 'input-small unauthorized_index', 'after' => '-to-',
                      'label' => array('class' => 'required', 'text' => 'Budget Create Dates'), 'placeHolder' => 'Start Date'));
              ...
              <th>
                <?php
                  echo $this->Form->input('pages', array(
                    'type' => 'select', 'div' => false, 'class' => 'span12', 'selected' => $this->request->params['paging']['Budget']['limit'],
                    'empty' => true,
    ...
    <table  class="table  table-bordered table-striped">
     <thead>
        ...
        <th><?php echo $this->Paginator->sort('grand_total_kshs'); ?></th>
        <th><?php echo $this->Paginator->sort('subject_kshs', 'Per subject'); ?></th>
    ...
    <tr class="">
        ...
        <td>
          <?php 
            ...
            echo $this->Html->link($budget['Budget']['grand_total_kshs'],
               array('controller' => 'applications', 'action' => 'view', $budget['Application']['id'], 'budget_view' => $budget['Budget']['id']), array('escape'=>false));
        ?>&nbsp;</td>
        <td><?php echo h($budget['Budget']['subject_kshs']); ?>&nbsp;</td>
        <td><?php 
        echo $this->Html->link($budget['Application']['protocol_no'], array('controller' => 'applications' , 'action' => 'view', $budget['Application']['id']), array('escape' => false));
        ?>&nbsp;</td>
...
$(function() {
  ...
  var adates = $('#BudgetStartDate, #BudgetEndDate').datepicker({
          minDate:"-100Y",
          maxDate:"-0D",
          dateFormat:'dd-mm-yy',
          format: 'dd-mm-yyyy',
          ...
          onSelect: function( selectedDate ) {
            var option = this.id == "BudgetStartDate" ? "minDate" : "maxDate",
