                    ...
                    <td>
                        ...
                        echo $this->Form->input(
                            ...
                            array(
                                ...
                                'class' => 'span12 unauthorized_index',
                                'label' => array('class' => 'required', 'text' => 'Patient Initials')
                            )
                        );
                        ?>
                    </td>
                    ...
                    <td colspan="2">
                        ...
                        echo $this->Form->input(
                            ...
                            array(
                                ...
                                'class' => 'span3',
                                'after' => '-to-',
                                'label' => array('class' => 'required', 'text' => 'Age'),
                                'placeHolder' => '0 years'
                            )
                        );
                        echo $this->Form->input(
                ...
                <tr>
                    ...
                    <td>
                        ...
                        echo $this->Form->input('pages', array(
                            ...
                            'div' => false,
                            'class' => 'input-small',
                            'selected' => $this->request->params['paging']['Sae']['limit'],
                            'empty' => true,
                        ...
                        <td style="<?= h($cellStyle) ?>"><?php echo h($sae['Sae']['report_type']);
                                                            if ($sae['Sae']['report_type'] == 'Followup') {
                                                                ...
                                                                echo $this->Html->link(
                                                                    ...
                                                                    array('action' => 'view', $sae['Sae']['sae_id']),
                                                                    array('escape' => false)
                                                                );
                                                            }
                                                            ?>&nbsp;</td>
