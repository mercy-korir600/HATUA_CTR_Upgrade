...
<div class="row-fluid">
  ...
  <div id="tabs">
      ...
      <table class="table  table-condensed">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <p class="xeditable iseditable" id="data[Application][investigator1_telephone]" data-type="text" data-pk="<?php echo $application['Application']['id']; ?>" data-original-title="Update telephone no"><?php echo $application['Application']['investigator1_telephone']; ?></p>
            </td>
          </tr>
          <tr>
            <td class="table-label required">
            ...
            <td>
              <p class="xeditable iseditable" id="data[Application][investigator1_email]" data-type="text" data-pk="<?php echo $application['Application']['id']; ?>" data-original-title="Update email address"><?php echo $application['Application']['investigator1_email']; ?></p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
      ...
      <?php foreach ($application['Pharmacist'] as $key => $pharmacist) { ?>
        ...
        <table class="table  table-condensed">
          <tbody>
            <tr>
              <td class="table-label required">
                <p>Registration Number <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Valid year <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Premise <span class="sterix">*</span></p>
              </td>
              <td>
            ...
            <tr>
              <td class="table-label required">
                <p>Physical address <span class="sterix">*</span></p>
              </td>
              <td>
            ...
            <tr>
              <td class="table-label required">
                <p>Mobile number <span class="sterix">*</span></p>
              </td>
              <td>
      ...
      <?php foreach ($application['Sponsor'] as $key => $sponsor) { ?>
        ...
        <table class="table  table-condensed">
          <tbody>
            <tr>
              <td class="table-label required">
                <p>Sponsor <span class="sterix">*</span></p>
              </td>
              <td><?php echo $sponsor['sponsor'] ?></td>
            </tr>
            <tr>
              <td class="table-label required">
                <p>Type <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Mobile phone number<span class="sterix">*</span></p>
              </td>
    ...
    <div id="tabs-4">
      ...
      <table class="table  table-condensed">
        <tbody>
          <tr>
            <td class="table-label required">
              <p>Expected Number of participants in Kenya <span class="sterix">*</span></p>
            </td>
          ...
          <tr>
            <td class="table-label">
              <p>Total enrolment in each Kenyan site: (if competitive enrolment, state minimum and maximum number per site.) </p>
            </td>
          ...
          <tr>
            <td class="table-label required">
              <p>Total participants worldwide <span class="sterix">*</span></p>
            </td>
      ...
      <table class="table  table-condensed">
        <tbody>
          <tr>
            <td class="table-label required">
              <p>Less than 18 years? <span class="sterix">*</span></p>
            </td>
      ...
      <div class="ctr-groups">
        ...
        <table class="table  table-condensed">
          <tbody>
            <tr>
              <td class="table-label required">
                <p>In Utero <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Preterm Newborn Infants (up to gestational age &lt; 37 weeks) <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Newborn (0-28 days) <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Infant and toddler (29 days - 23 months) <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Children (2-12 years) <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Adolescent (13-17 years) <span class="sterix">*</span></p>
              </td>
      ...
      <table class="table  table-condensed">
        <tbody>
          <tr>
            <td class="table-label required">
              <p>18 Years and over <span class="sterix">*</span></p>
            </td>
      ...
      <div class="ctr-groups">
        ...
        <table class="table  table-condensed">
          <tbody>
            <tr>
              <td class="table-label required">
                <p>Adult (18-65 years) <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Elderly (&gt; 65 years) <span class="sterix">*</span></p>
              </td>
      ...
      <table class="table  table-condensed">
        <tbody>
          <tr>
            <td class="table-label required">
              <p>Healthy volunteers <span class="sterix">*</span></p>
            </td>
          ...
          <tr>
            <td class="table-label required">
              <p>Specific vulnerable populations <span class="sterix">*</span></p>
            </td>
      ...
      <div class="ctr-groups">
        ...
        <table class="table  table-condensed">
          <tbody>
            <tr>
              <td class="table-label required">
                <p>Patients <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Women of child bearing potential <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Women of child bearing potential using contraception <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Pregnant women <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Nursing Women <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Emergency situation <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Subjects incapable of giving consent personally <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>If yes, specify <span class="sterix">*</span></p>
              </td>
            ...
            <tr>
              <td class="table-label required">
                <p>Others <span class="sterix">*</span></p>
              </td>
      ...
      <table class="table  table-condensed">
        <tbody>
          <tr>
            ...
            <td>
              <p><?php echo ($application['Application']['gender_female']   ? $ichecked : $nchecked); ?> Female</p>
            </td>
          </tr>
          <tr>
            <td class="table-label table-noline">
              <p></p>
            </td>
            <td class="table-noline">
              <p><?php echo ($application['Application']['gender_male']   ? $ichecked : $nchecked); ?> Male</p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
    ...
    <div id="tabs-5">
      ...
      <table class="table  table-condensed">
        <tbody>
          <tr>
            <td class="table-label">
              <p>Single site in Kenya <span class="sterix">*</span></p>
            </td>
            <td>
              <p><?php echo $application['Application']['single_site_member_state']; ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
          ...
          <tr>
            <td class="table-label">
              <p>If yes, name of site</p>
            </td>
            <td>
              <p><?php echo $application['Application']['location_of_area']; ?> </p>
            </td>
          </tr>
          <tr>
            <td class="table-label">
            ...
            <td>
              <p class="xeditable iseditable" id="data[Application][single_site_physical_address]" data-type="text" data-pk="<?php echo $application['Application']['id']; ?>" data-original-title="Update physical address"><?php echo $application['Application']['single_site_physical_address']; ?> </p>
            </td>
          </tr>
          <tr>
            <td class="table-label">
            ...
            <td>
              <p class="xeditable iseditable" id="data[Application][single_site_contact_person]" data-type="text" data-pk="<?php echo $application['Application']['id']; ?>" data-original-title="Update contact person"><?php echo $application['Application']['single_site_contact_person']; ?> </p>
            </td>
          </tr>
          <tr>
            <td class="table-label">
            ...
            <td>
              <p class="xeditable iseditable" id="data[Application][single_site_telephone]" data-type="text" data-pk="<?php echo $application['Application']['id']; ?>" data-original-title="Update telephone"><?php echo $application['Application']['single_site_telephone']; ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
      ...
      <div class="ctr-groups">
        <table class="table  table-condensed">
          <tbody>
            <tr>
              <td class="table-label">
                <p>Multiple sites in Kenya <span class="sterix">*</span></p>
              </td>
              <td>
                <p><?php echo $application['Application']['multiple_sites_member_state']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
            ...
            <tr>
              <td class="table-label">
                <p>Number of sites anticipated in Kenya</p>
              </td>
              <td>
                <p><?php echo $application['Application']['number_of_sites']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
          ...
          <table class="table  table-condensed">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <p class="xeditable iseditable" id="data[SiteDetail][<?php echo $key; ?>][physical_address]" data-type="text" data-pk="<?php echo $siteDetail['id']; ?>" data-original-title="Update Physical address"><?php echo $siteDetail['physical_address'] ?></p>
                </td>
              </tr>
              <tr>
                <td class="table-label required">
                  <p>Contact details <small style="font-weight:normal;"><em>(tel.no, p.o box..) </em></small></p>
                </td>
      ...
      <table class="table  table-condensed">
        <tbody>
          <tr>
            <td class="table-label">
              <p>Multiple Countries <span class="sterix">*</span></p>
            </td>
            <td>
              <p><?php echo $application['Application']['multiple_countries']; ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
          ...
          <tr>
            <td class="table-label">
              <p>If yes above, list the countries</p>
            </td>
            <td>
              <p><?php echo $application['Application']['multi_country_list']; ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
          ...
          <tr>
            <td class="table-label">
              <p>Does this trial have a data monitoring committee? <span class="sterix">*</span> </p>
            </td>
            <td>
              <p><?php echo $application['Application']['data_monitoring_committee']; ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
      ...
      <table class="table  table-condensed">
        <tbody>
          <tr>
            <td class="table-label">
              <p>Capacity of Site(s) <span class="sterix">*</span></p>
            </td>
            <td>
              <p><?php echo $application['Application']['staff_numbers']; ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
    ...
    <div id="tabs-6">
      ...
      <table class="table  table-condensed">
        <tbody>
          <tr>
            <td class="table-label required">
              <p>Is there a placebo? <span class="sterix">*</span></p>
            </td>
            <td>
              <p><?php echo $application['Application']['placebo_present']; ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
        ...
        <?php foreach ($application['Placebo'] as $key => $placebo) { ?>
          ...
          <table class="table  table-condensed">
            <tbody>
              ...
              <tr>
                <td class="table-label required">
                  <p>Composition, apart from active substance(s) </p>
                </td>
                <td><?php echo $placebo['composition'] ?></td>
              </tr>
              <tr>
                <td class="table-label required">
                  <p>Is it otherwise identical to the INDP?</p>
                </td>
                <td><?php echo $placebo['identical_indp'] ?></td>
              </tr>
              <tr>
                <td class="table-label required">
                  <p>If not, specify major ingredients</p>
                </td>
    ...
    <div id="tabs-7">
      <table class="table  table-condensed">
        <tbody>
          <tr>
            <td class="table-label">
              <h5>7.0 STUDY OBJECTIVES <span class="sterix">*</span></h5>
            </td>
            <td>
              <p><?php echo $application['Application']['study_objectives']; ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
          ...
          <tr>
            <td class="table-label">
              <h5>7.1 PRINCIPAL INCLUSION CRITERIA <span class="sterix">*</span></h5>
            </td>
            <td>
              <p><?php echo $application['Application']['principal_inclusion_criteria']; ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
          ...
          <tr>
            <td class="table-label">
              <h5>7.2 PRINCIPAL EXCLUSION CRITERIA <span class="sterix">*</span></h5>
            </td>
            <td>
              <p><?php echo $application['Application']['principal_exclusion_criteria']; ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
          ...
          <tr>
            <td class="table-label">
              <h5>7.3 PRIMARY END POINTS <span class="sterix">*</span></h5>
            </td>
            <td>
              <p><?php echo $application['Application']['primary_end_points']; ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
    ...
    <div id="tabs-8">
      ...
      <table class="table  table-condensed">
        <tbody>
          <tr>
            <td>
              <p class="control-nolabel"><?php echo ($application['Application']['scope_diagnosis']   ? $ichecked : $nchecked); ?> Diagnosis</p>
            </td>
            <td>
              <p class="control-nolabel"><?php echo ($application['Application']['scope_prophylaxis']   ? $ichecked : $nchecked); ?> Prophylaxis</p>
            </td>
          </tr>
          <tr>
            <td class="table-noline">
              <p class="control-nolabel"><?php echo ($application['Application']['scope_therapy']   ? $ichecked : $nchecked); ?> Therapy</p>
            </td>
            <td class="table-noline">
              <p class="control-nolabel"><?php echo ($application['Application']['scope_safety']   ? $ichecked : $nchecked); ?> Safety </p>
            </td>
          </tr>
          <tr>
            <td class="table-noline">
              <p class="control-nolabel"><?php echo ($application['Application']['scope_efficacy']   ? $ichecked : $nchecked); ?> Efficacy </p>
            </td>
            <td class="table-noline">
              <p class="control-nolabel"><?php echo ($application['Application']['scope_pharmacokinetic']   ? $ichecked : $nchecked); ?> Pharmacokinetic</p>
            </td>
          </tr>
          <tr>
            <td class="table-noline">
              <p class="control-nolabel"><?php echo ($application['Application']['scope_pharmacodynamic']   ? $ichecked : $nchecked); ?> Pharmacodynamic</p>
            </td>
            <td class="table-noline">
              <p class="control-nolabel"><?php echo ($application['Application']['scope_bioequivalence']   ? $ichecked : $nchecked); ?> Bioequivalence</p>
            </td>
          </tr>
          <tr>
            <td class="table-noline">
              <p class="control-nolabel"><?php echo ($application['Application']['scope_dose_response']   ? $ichecked : $nchecked); ?> Dose Response </p>
            </td>
            <td class="table-noline">
              <p class="control-nolabel"><?php echo ($application['Application']['scope_pharmacogenetic']   ? $ichecked : $nchecked); ?> Pharmacogenetic</p>
            </td>
          </tr>
          <tr>
            <td class="table-noline">
              <p class="control-nolabel"><?php echo ($application['Application']['scope_pharmacogenomic']   ? $ichecked : $nchecked); ?> Pharmacogenomic</p>
            </td>
            <td class="table-noline">
              <p class="control-nolabel"><?php echo ($application['Application']['scope_pharmacoecomomic']   ? $ichecked : $nchecked); ?> Pharmacoecomomic</p>
            </td>
          </tr>
          <tr>
            <td class="table-noline">
              <p class="control-nolabel"><?php echo ($application['Application']['scope_others']   ? $ichecked : $nchecked); ?> Others</p>
            </td>
            <td class="table-noline">
              <p><?php echo $application['Application']['scope_others_specify']   ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
      ...
      <table class="table  table-condensed">
        <tbody>
          <tr>
            <td colspan="2">
              <p class="control-nolabel"><?php echo ($application['Application']['trial_human_pharmacology']   ? $ichecked : $nchecked); ?> Human pharmacology (Phase I) </p>
              <p>Is it:
            </td>
          </tr>
          <tr>
            <td class="table-noline" colspan="2">
              <p class="control-nolabel"><?php echo ($application['Application']['trial_administration_humans']   ? $ichecked : $nchecked); ?> First administration to humans</p>
            </td>
          </tr>
          <tr>
            <td class="table-noline" colspan="2">
              <p class="control-nolabel"><?php echo ($application['Application']['trial_bioequivalence_study']   ? $ichecked : $nchecked); ?> Bioequivalence study </p>
            </td>
          </tr>
          <tr>
            <td class="table-noline" colspan="2">
              <p class="control-nolabel"><?php echo ($application['Application']['trial_other']   ? $ichecked : $nchecked); ?> Other</p>
              <p><?php echo $application['Application']['trial_other_specify']; ?> </p>
            </td>
          </tr>
          <tr>
            <td class="table-noline" colspan="2">
              <p class="control-nolabel"><?php echo ($application['Application']['trial_therapeutic_exploratory']   ? $ichecked : $nchecked); ?> Therapeutic exploratory (Phase II) </p>
            </td>
          </tr>
          <tr>
            <td class="table-noline" colspan="2">
              <p class="control-nolabel"><?php echo ($application['Application']['trial_therapeutic_confirmatory']   ? $ichecked : $nchecked); ?> Therapeutic confirmatory (Phase III) </p>
            </td>
          </tr>
          <tr>
            <td class="table-noline" colspan="2">
              <p class="control-nolabel"><?php echo ($application['Application']['trial_therapeutic_use']   ? $ichecked : $nchecked); ?> Therapeutic use (Phase IV) </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
    ...
    <div id="tabs-9">
      ...
      <table class="table  table-condensed">
        <tbody>
          <tr>
            <td class="table-label">
              <p>Controlled <span class="sterix">*</span></p>
            </td>
            <td>
              <p><?php echo $application['Application']['design_controlled']; ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
      ...
      <div class="ctr-groups">
        ...
        <table class="table  table-condensed">
          <tbody>
            <tr>
              <td class="table-label">
                <p>Randomised <span class="sterix">*</span></p>
              </td>
              <td>
                <p><?php echo $application['Application']['design_controlled_randomised']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
            ...
            <tr>
              <td class="table-label">
                <p>Open <span class="sterix">*</span></p>
              </td>
              <td>
                <p><?php echo $application['Application']['design_controlled_open']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
            ...
            <tr>
              <td class="table-label">
                <p>Single Blind <span class="sterix">*</span></p>
              </td>
              <td>
                <p><?php echo $application['Application']['design_controlled_single_blind']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
            ...
            <tr>
              <td class="table-label">
                <p>Double Blind <span class="sterix">*</span></p>
              </td>
              <td>
                <p><?php echo $application['Application']['design_controlled_double_blind']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
            ...
            <tr>
              <td class="table-label">
                <p>Parallel group <span class="sterix">*</span></p>
              </td>
              <td>
                <p><?php echo $application['Application']['design_controlled_parallel_group']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
            ...
            <tr>
              <td class="table-label">
                <p>Cross over <span class="sterix">*</span></p>
              </td>
              <td>
                <p><?php echo $application['Application']['design_controlled_cross_over']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
            ...
            <tr>
              <td class="table-label">
                <p>Other <span class="sterix">*</span></p>
              </td>
              <td>
                <p><?php echo $application['Application']['design_controlled_other']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
            ...
            <tr>
              <td class="table-label">
                <p>If yes to other, specify </p>
              </td>
              <td>
                <p><?php echo $application['Application']['design_controlled_specify']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
            ...
            <tr>
              <td class="table-label">
                <p>If controlled, specify the comparator</p>
              </td>
              <td>
                <p><?php echo $application['Application']['design_controlled_comparator']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
            ...
            <tr>
              <td class="table-label">
                <p>Other medicinal product(s) </p>
              </td>
              <td>
                <p><?php echo $application['Application']['design_controlled_other_medicinal']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
            ...
            <tr>
              ...
              <td>
                <p><?php echo $application['Application']['design_controlled_placebo']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
            ...
            <tr>
              ...
              <td>
                <p><?php echo $application['Application']['design_controlled_medicinal_other']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
            ...
            <tr>
              ...
              <td>
                <p><?php echo $application['Application']['design_controlled_medicinal_specify']; ?> </p>
              </td>
            </tr>
            <?php
            foreach ($application['Amendment']  as $key => $amendment) {
      ...
      <?php foreach ($application['Budget'] as $key => $budget) { ?>
        ...
        <div class="page-header">
          <div class="styled_title">
            <h3>BUDGET AND JUSTIFICATION</h3>
          </div>
        </div>
        ...
        <?php foreach ($application['Organization'] as $key => $organization) { ?>
          ...
          <table class="table  table-condensed">
            <tbody>
              <tr>
                <td class="table-label required">
                  <p>Organization <span class="sterix">*</span></p>
                </td>
                <td><?php echo $organization['organization'] ?></td>
              </tr>
              <tr>
                <td class="table-label table-noline">
                  <p>Name of contact person <span class="sterix">*</span></p>
                </td>
    ...
    <div id="tabs-11">
      ...
      <table class="table table-condensed">
        <thead>
          <tr class="control-nolabel">
            <th colspan="2">
              <h5> 12.1 If the trial is to be conducted in Kenya and not in the host country of the applicant / sponsor, provide an explanation <span class="sterix">*</span></h5>
            </th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td colspan="2"><?php echo $application['Application']['other_details_explanation'] ?></td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
      ...
      <table class="table table-condensed">
        <thead>
          <tr class="control-nolabel">
            <th colspan="2">
              <h5> 12.2 Estimated duration of trial <span class="sterix">*</span></h5>
            </th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td colspan="2"><?php echo $application['Application']['estimated_duration'] ?></td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
      ...
      <table class="table table-condensed">
        <thead>
          <tr class="control-nolabel">
            <th colspan="2">
              <h5> 12.3 Name other Regulatory Authorities to which applications to do this trial have been submitted, but approval has not yet been granted. Include date(s) of application: <span class="sterix">*</span></h5>
            </th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td colspan="2"><?php echo $application['Application']['other_details_regulatory_notapproved'] ?></td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
      ...
      <table class="table table-condensed">
        <thead>
          <tr class="control-nolabel">
            <th colspan="2">
              <h5> 12.4 Name other Regulatory Authorities which have approved this trial, date(s) of approval and number of sites per country. <span class="sterix">*</span></h5>
            </th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td colspan="2"><?php echo $application['Application']['other_details_regulatory_approved'] ?></td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
      ...
      <table class="table table-condensed">
        <thead>
          <tr class="control-nolabel">
            <th colspan="2">
              <h5> 12.5 if applicable, name other Regulatory Authorities or Ethics Committees which have rejected this trial and give reasons for rejection:<span class="sterix">*</span></h5>
            </th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td colspan="2"><?php echo $application['Application']['other_details_regulatory_rejected'] ?></td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
      ...
      <table class="table table-condensed">
        <thead>
          <tr class="control-nolabel">
            <th colspan="2">
              <h5> 12.6 If applicable, details of and reasons for this trial having been halted at any stage by other Regulatory Authorities: <span class="sterix">*</span></h5>
            </th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td colspan="2"><?php echo $application['Application']['other_details_regulatory_halted'] ?></td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
    ...
    <div id="tabs-12">
      ...
      <table class="table  table-condensed">
        <tbody>
          ...
          <?php
          $deeds = $this->requestAction('/pockets/checklist/protocol');
          foreach ($deeds as $name => $content) {
          ?>
            <tr>
              <td style="width:5%;">
                <p class="control-checklabel"><?php echo $num++; ?>. </p>
              </td>
              <td>
                <p class="control-nolabel required"><?php echo ($application['Application'][$name]   ? $ichecked : $nchecked);
                                                    echo ' ' . $content; ?></p>
                <?php
    ...
    <div id="tabs-13">
      ...
      <table class="table  table-condensed">
        <tbody>
          <tr>
            <td class="table-label required">
              <p>Applicant (local contact) <span class="sterix">*</span></p>
            </td>
            <td>
              <p><?php echo $application['Application']['declaration_applicant']; ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
          ...
          <tr>
            ...
            <td class="table-noline">
              <p><?php echo $application['Application']['declaration_date1']; ?> </p>
            </td>
          </tr>
          <?php
          foreach ($application['Amendment']  as $key => $amendment) {
          ...
          <tr>
            <td class="table-label required">
              <p>National Principal Investigator / National Co-ordinator / Other (state designation) </p>
            </td>
            <td>
    ...
    <div id="tabs-14">
      ...
      <table class="table  table-condensed">
        <thead>
          <tr>
            <th class="table-label required" colspan="2">
              <h5>Any other comment(s)</h5>
            </th>
          </tr>
        </thead>
        <tbody>
